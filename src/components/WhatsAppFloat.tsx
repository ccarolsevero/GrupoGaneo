...
export function WhatsAppFloat() {
  return (
    <a
      href={`${site.whatsappHref}?text=${encodeURIComponent("Olá! Gostaria de um orçamento para construção de lago.")}`}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Falar no WhatsApp"
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-bold text-white shadow-[0_12px_30px_rgba(37,211,102,0.45)] transition hover:scale-[1.03] hover:bg-[#1ebe57]"
    >
